...
WOQLClient.prototype.createUser = function(uid, doc) {
    if (uid) {
        return this.dispatch(CONST.CREATE_USER, this.connectionConfig.userURL(uid), doc)
    }
...
WOQLClient.prototype.prepareRevisionControlArgs = function(rc_args) {
    ...
    if (!rc_args.author) rc_args.author = this.connection.author()
    return rc_args
}
