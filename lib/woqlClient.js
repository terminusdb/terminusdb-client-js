 ...
 * @param {object} params - json object containing params to be set
 * otherwise jwt will come back if set, if not set, local id
 */
 ...
 * @param {string} gid TerminusDB Graph Filter Pattern
...
WOQLClient.prototype.branch = function(new_branch_id) {
	...
	let errmsg = `Branch parameter error - you must specify a valid new branch id and there must be a ref set in the client as the base of the branch`
	return Promise.reject(
