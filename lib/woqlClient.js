 ...
 */
WOQLClient.prototype.account = function(accid) {
    if (typeof accid != 'undefined') {
        return this.connectionConfig.setAccount(accid)
    }
 ...
 */
WOQLClient.prototype.user_account = function() {
...
WOQLClient.prototype.createDatabase = function(dbid, doc, accountid) {
    accountid = accountid || this.user_account()
...
WOQLClient.prototype.deleteDatabase = function(dbid, accountid) {
    ...
    this.account(accountid)
    if (dbid && this.db(dbid)) {
        return this.dispatch(CONST.DELETE_DATABASE, this.connectionConfig.dbURL()).then(
            response => {
                this.connection.removeDB(this.db(), accountid)
                return response
            },
        )
    }
