...
WOQLClient.prototype.connect = function (curl, key, dbid, branchid, jwt) {
	...
	return this.dispatch(CONST.CONNECT,null,null,jwt)
	.then((response) => {
...
WOQLClient.prototype.createDatabase = function (details, key,jwt) {
	if(details && details['@id']){
		...
		return this.dispatch(CONST.CREATE_DATABASE, doc,null,jwt);
	}
	else {
...
WOQLClient.prototype.deleteDatabase = function (key,jwt) {
	...
	const self = this;
	return this.dispatch(CONST.DELETE_DATABASE, opts, null,jwt).then(
		(response) => {
 ...
 */
WOQLClient.prototype.dispatch = function (action, payload, extra, jwt=null) {
