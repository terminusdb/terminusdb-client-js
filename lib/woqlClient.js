...
WOQLClient.prototype.clone = function (refid, newid) {
	doc = {
		"@type": "terminus:APIUpdate",
		"terminus:resource": refid
	}
	return this.dispatch(CONST.CLONE, doc, newid);
};

WOQLClient.prototype.fetch = function (repoid) {
	//doc = this.wrapDocumentForAPI(doc, opts);
	return this.dispatch(CONST.FETCH, {}, repoid);
};

WOQLClient.prototype.rebase = function (remote_repo_id) {
	//doc = this.wrapDocumentForAPI(doc, opts);
	return this.dispatch(CONST.REBASE, {}, remote_repo_id);
};
...
WOQLClient.prototype.branch = function (doc, opts) {
	doc = this.wrapDocumentForAPI(doc, opts);
	return this.dispatch(CONST.BRANCH, doc);
};

WOQLClient.prototype.createGraph = function (type, gid) {
	gid = gid || "main"
	return this.dispatch(CONST.CREATE_GRAPH, {}, type + "/" + gid);
};
