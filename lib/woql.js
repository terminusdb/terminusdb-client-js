...
WOQL.read_object = function(IRI, Format){ return new WOQLQuery().read_object(IRI, Format);	}
 ...
 * @return {object} WOQLQuery
 */
WOQL.upper = function(u, l){	return new WOQLQuery().upper(l, u); }
 ...
 * @return {object} WOQLQuery
 */
WOQL.star = function(GraphIRI, Subj, Pred, Obj){	return new WOQLLibrary().getEverything(GraphIRI, Subj, Pred, Obj) }
