...
/**
 *
 * Groups the results of the contained subquery on the basis of identical values
 * for Groupvars (varList), extracts the patterns defined in PatternVars and stores
 * the results in GroupedVar
