 ...
 * @param {string | number} resultVarName - Either a variable, in which the result of the
 ...
 * @param {...(string |number)} args - variable or numeric containing the value that will be
 * subtracted from
 ...
 * @param {string | number} varNum -  a variable or numeric containing the number to be
 ...
 * @param {array | string} inputVarList - An array of variables and / or strings from which the
 ...
 * @param {number | string} len - The variable or integer value representing the length of
 * the output string
 ...
 * @param {string} separator - A string or variable containing a sequence of charatcters
 ...
 * @param {string} list - List ([string, literal] or string*) Either a variable representing a
 * list or a list of variables or literals
 ...
 * @param {array | string} varList -  a variable representing a list or a list of variables or
 ...
 * together with Glue
 * @param {string | array} varList - a variable representing a list or a list of strings
 * and / or variables
 * @param {string} glue - A variable (v:glue) or (glue) string representing the characters
 ...
 * @param {string} inputVarName - string or variable containing the string to be tested for
 * patterns with the regex
 * @param {string | array | object} resultVarList - variable representing the list of matches
 ...
 * @param {string} resultVarName -  A variable in which the length of the list is stored or
 ...
 * @param {string | number | object} varName - Either a single variable or a
 ...
 * @param  {...string} varNames - A sequence of variables, by which to order the results,
 ...
 * @param {string} resourceId - A valid resource identifier string (can refer to any graph /
 * branch / commit / db)
 ...
 * @param {string} resourceId - A valid resource identifier string (can refer to any graph /
 * branch / commit / db)
 * @param {string | number} tripleCount - An integer literal with the size in bytes or a
 ...
 * @param {string} nodeid -  The IRI of a node or a variable containing an IRI which will
 ...
 * @param {string} classType  -  IRI string or variable containing the IRI of the
 ...
 * @returns {array} an array of javascript variables which can be dereferenced using the
 ...
 * @param  {object} object The document which needs to be created
 * @returns {object} a object with encoded document
 * @example
