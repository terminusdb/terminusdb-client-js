 ...
 *
 * @param {string} GraphFilter 	- optional target graph 	false is the default value and get all the database's graphs, possible value are  | false | schema/{main - myschema - *} | instance/{main - myschema - *}  | inference/{main - myschema - *} 
 ...
 * @return {object} WOQLQuery
 */
WOQL.star = function(GraphFilter, Subj, Pred, Obj){	return new WOQLQuery().star(GraphFilter, Subj, Pred, Obj) }
 ...
 * @param {string} GraphFilter - target graph, optional
 * @return {object} WOQLQuery
 */
WOQL.insert = function(Node, Type, GraphFilter){ return new WOQLQuery().insert(Node, Type, GraphFilter) };
