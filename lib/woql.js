...
//require('./query/woqlCore')
//require('./query/woqlQuery')
//require('./query/woqlSchema')
 ...
 * @param {WOQLQuery | string} asvars - an array of AsVar variable mappings (see as for format below)
 ...
 * @param {WOQLQuery | String} varsToExp - an array of AsVar variable mappings (see as for format below)
...
//KEVIN ANY GRAPH OR ONLY instance
/**
