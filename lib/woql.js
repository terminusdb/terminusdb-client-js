...
WOQLQuery.prototype.like = function(stringa, stringb, lev_distance){
	let args = [this.packString(stringa), this.packString(stringb)]
	if(lev_distance) args.push(lev_distance)
	this.cursor["like"] = args;
	return this;
}
