 ...
 * @param {string|Var} resultVarName - variable that stores the generated ID
 ...
 * @param {number|string|Var} limit - A variable that refers to an non-negative integer or a
 ...
 * @param {string|Var} pattern - string or variable using normal PCRE regular expression syntax with
