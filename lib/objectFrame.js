...
ObjectFrame.prototype.getAsFrame = function (prop, parent) {
	...
	ff.frame = [];
	for (const pFrame of this.dataframes.keys()) {
...
ObjectFrame.prototype.clear = function () {
	this.clearData();
	const newkids = {};
	for (const prop of this.children.keys()) {
...
ObjectFrame.prototype.clearData = function () {
	for (const prop of this.dataframes.keys()) {
...
ObjectFrame.prototype.matchesPattern = function (matching, pattern) {
	...
	if (pattern.type === 'property' && (typeof matching.value === 'undefined'
	&& typeof matching.property !== 'undefined')) {

	}
	if (pattern.type === 'object' && (typeof matching.value !== 'undefined'
	|| typeof matching.property !== 'undefined')) {
...
ObjectFrame.prototype.getMissingPropertyList = function () {
	...
	if (this.classframes && typeof this.classframes === 'object') {
		//for (const prop of this.classframes.keys()) {
...
DataFrame.prototype.getTypeShorthand = function () {
	...
	return FrameHelper.getShorthand(this.range);
};
