...
WOQLClient.prototype.userOrganization = function() {
    return this.uid() || this.connectionConfig.user()
}
...
WOQLClient.prototype.connect = function(params) {
    ...
    if (!this.server()) {
        ...
        return Promise.reject(
            new URIError(ErrorMessage.getInvalidURIMessage(message, CONST.GET)),
        )
    }
...
//document interface
WOQLClient.prototype.addDocument = function(json,params,dbId){
    if (dbId) {
        this.db(dbId)
    }
    return this.dispatch(CONST.POST, this.connectionConfig.documentURL(params), json)
}

//document interface
WOQLClient.prototype.getDocument = function(json,params,dbId){
    if (dbId) {
        this.db(dbId)
    }
...
WOQLClient.prototype.updateDocument = function(json,params,dbId){
