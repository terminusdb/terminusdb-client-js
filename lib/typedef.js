//typedef
/**
 *@typedef {Object} DocParamsPost - the document interface query parameters
 *@property {string} graph_type - instance|schema
 *@property {string} author
 *@property {string} message
 *@property {string} graph_type
 *@property {string} overwrite
 *@property {string} full_replace
 */

 /*
 *@property {string} type - only the specific document type will be returned
 *@property {string} id - get a specific document id
 *@property {string} 
 */
