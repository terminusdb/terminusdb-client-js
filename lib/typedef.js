...
/**
 * @typedef {Object} CloneDetails
 * @property {string} remote_url - The URL of the database to clone
 * @property {string} [label] - The label to use for the cloned database
 * @property {string} [comment] - The comment to use in the cloned database
 */
