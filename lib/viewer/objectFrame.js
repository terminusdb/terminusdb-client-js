...
function DataFrame(jsonld, parent, index) {
	...
	this.index = index;
	this.type = "datatypeProperty";
    this.domain = parent.cframe.domain;
    this.predicate = parent.cframe.predicate;
	this.frame = parent.cframe.frame;
    this.label = parent.getLabel();
    this.comment = parent.getComment();
    this.range = jsonld["@type"]

	const { restriction } = parent.cframe;
