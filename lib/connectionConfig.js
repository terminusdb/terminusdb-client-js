...
ConnectionConfig.prototype.cloneURL = function(new_repo_id) {
    let crl = `${this.serverURL()}clone/${this.organization()}`
 ...
 */
ConnectionConfig.prototype.fetchURL = function() {
