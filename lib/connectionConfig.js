 ...
 * @property {string}  params.key - api key for basic auth
 * @property {string}  params.user - basic auth user id
 * @property {?string} params.organization - set organization to this id
 * @property {?string} params.db - set cursor to this db
 * @property {?RepoType | string} params.repo - set cursor to this repo
 * @property {?string} params.branch - set branch to this id
 * @property {?string} params.ref    - set commit ref 
 * @property {?string} params.jwt - jwt token 
 * @property {?string} params.jwt_user - jwt user id
 * @property {?string} params.default_branch_id - set the default branch id 
*/
 ...
 * @param {?RepoType | string} params.repo - set cursor to this repo
 * @param {?string} params.branch - set branch to this id
 * @param {?string} params.ref    - set commit ref 
