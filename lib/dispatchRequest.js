 ...
 * @returns {object} Object having two properties result and version
 */
function getResultWithVersion(response) {
    return {
      result: response.data,
      version: response.headers["terminusdb-data-version"]
 ...
 */
function DispatchRequest(url, action, payload, local_auth, remote_auth = null, customHeaders = null, getVersion = false) {
    /*
    ...
    switch (action) {
        case CONST.DELETE:
            ...
            return axiosInstance
                .delete(url, options)
                .then(response => getVersion ? getResultWithVersion(response) : response.data)
                .catch(err => {
