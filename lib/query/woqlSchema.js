//WOQLQuery
const WOQLQueryImp = require('./woqlQuery')
...
//var WOQLQuery = Object.create(WOQLQueryImp)
 ...
 * @param {typedef.ClassObj} data with id, label, description, parent and properties
...
/**
 *
 * @param {typedef.PropertyObj} data
 ...
 * @param {string} c - class ID
 * @param {string} [graph] - schema graph identifier
 * @param {string} [cvar] - the var name
 * @returns WOQLQuery object
 */
