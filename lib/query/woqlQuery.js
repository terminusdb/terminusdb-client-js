...
WOQLQuery.prototype.as = function(...varList){
	...
	//if(this.cursor["@type"]){
		//if((typeof varList[0]  == "number" &&  this.cursor["@type"] == "woql:NamedAsVars") || (typeof varList[0]  == "number" &&  this.cursor["@type"] == "woql:IndexedAsVars")){
		//	this.cursor["@type"] = "woql:AsVars"
		//} 
	//}
	//else {
		//this.cursor["@type"] = (typeof varList[0]  == "number" ? "woql:IndexedAsVars" : "woql:NamedAsVars")
	//}
...
WOQLQuery.prototype.cast = function(inputVar, type, outputVar){
	if(inputVar && inputVar == "woql:args") return ["woql:typecast_value", 'woql:typecast_type', 'woql:typecast_result']
	this.cursor["@type"] = "woql:Typecast"
	this.cursor['woql:typecast_value'] = this.cleanObject(inputVar)
	this.cursor['woql:typecast_type'] = this.cleanObject(type)
	this.cursor['woql:typecast_result'] = this.cleanObject(outputVar)
	return this;
}
