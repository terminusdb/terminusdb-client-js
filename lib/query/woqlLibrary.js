 ...
 */
WOQLLibrary.prototype.getStructuralMetadata = function(branch, ref, cresource){
    if(ref){
...
WOQLLibrary.prototype.loadCommitDetails = function(client, commit_name, commitvar){
    return this.getCommitDetails(client.resource("commits"), commit_name, commitvar)
}	
