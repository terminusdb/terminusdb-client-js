...
WOQLLibrary.prototype.classesAndChoices = function(values, variables, schema_resource) {
    ...
    let qpattern = new WOQLQuery().and(
        ...
        new WOQLQuery()
            ...
            .group_by(
                'v:Class ID',
                ['v:choice id', 'v:choice label', 'v:choice description'],
                'v:Choices',
            )
            .and(
                new WOQLQuery()
                    .select('v:choice id')
                    .distinct('v:choice id')
...
WOQLLibrary.prototype.classes = function(values, variables, schema_resource) {
    ...
    let qpattern = new WOQLQuery().select(...select_vars).and(
        ...
        new WOQLQuery()
            ...
            .or(
                new WOQLQuery()
                    .quad(this._varn('Class ID'), 'system:tag', 'system:abstract', g)
                    .eq(this._varn('Abstract'), 'Yes'),
        ...
        new WOQLQuery()
            ...
            .or(
                new WOQLQuery()
                    .group_by(this._varn('Class ID'), this._varn('Parent'), this._varn('Parents'))
                    .and(
                        new WOQLQuery().quad(
                            this._varn('Class ID'),
                            'subClassOf',
        ...
        new WOQLQuery()
            ...
            .or(
                new WOQLQuery()
                    .group_by(this._varn('Class ID'), this._varn('Child'), this._varn('Children'))
                    .and(
                        new WOQLQuery().quad(
                            this._varn('Child'),
                            'subClassOf',
...
WOQLLibrary.prototype.properties = function(values, variables, schema_resource) {
    ...
    let qpattern = new WOQLQuery().select(...select_vars).and(
        new WOQLQuery()
            .quad(this._varn('Property ID'), 'type', this._varn('OWL Type'), g)
        ...
        new WOQLQuery()
            ...
            .or(
                new WOQLQuery().quad(
                    this._varn('Property ID'),
                    'label',
                    this._varn('Property Name'),
                    g,
                ),
        ...
        new WOQLQuery()
            ...
            .or(
                new WOQLQuery().quad(
                    this._varn('Property ID'),
                    'comment',
                    this._varn('Property Description'),
                    g,
                ),
...
WOQLLibrary.prototype.objects = function(values, variables) {
    ...
    if (variables) this._set_user_variables(variables)
    let qpattern = new WOQLQuery().triple(
        this._varn('Object ID'),
        'type',
        this._varn('Object Type'),
    )
    return this._add_constraints(qpattern, values)
}
...
WOQLLibrary.prototype.property_values = function(values, variables) {
    ...
    let qpattern = new WOQLQuery().select(...select_vars).or(
        new WOQLQuery()
        ...
        new WOQLQuery()
            .triple(
                this._varn('Object ID'),
                this._varn('Property ID'),
                this._varn('Property Value'),
            )
            .not()
            .triple(this._varn('Property Value'), 'type', this._varn('Any Class'))
            .comment(
...
WOQLLibrary.prototype.repos = function(values, variables, cresource) {
    ...
    let woql = new WOQLQuery().and(
        new WOQLQuery()
            .triple(
                this._varn('Repository IRI'),
                'repo:repository_name',
                this._varn('Repository Name'),
            )
        ...
        new WOQLQuery()
            ...
            .triple(
                ...
                this._varn('Repository Head IRI'),
            ),
        new WOQLQuery().or(
            new WOQLQuery().eq(this._varn('Repository Type'), 'repo:Local'),
            new WOQLQuery()
                .eq(this._varn('Repository Type'), 'repo:Remote')
...
WOQLLibrary.prototype.active_commit_id = function(branch, ts, commit_var) {
    ...
    let q = new WOQLQuery()
        ...
        .or(
            new WOQLQuery()
                .triple(hiri, 'ref:commit_timestamp', hts)
            ...
            new WOQLQuery()
                .or(
                    new WOQLQuery()
                        .path(hiri, 'ref:commit_parent+', ciri, cpath)
...
WOQLLibrary.prototype.history_ids = function(commit_id, count, commit_var) {
    ...
    q.triple(commit_iri, 'ref:commit_id', commit_id).or(
