...
WOQLLibrary.prototype.getBranchGraphNames = function(branch_name){
	let woql = new WOQLQuery().select("v:InstanceName", "v:SchemaName", "v:InferenceName", "v:HeadName").and(
		new WOQLQuery().triple("v:Branch", "ref:branch_name", branch_name),
		new WOQLQuery().triple("v:Branch", "ref:ref_commit", "v:Head"), 
		new WOQLQuery().triple("v:Head", "ref:commit_name", "v:HeadName"), 
...
WOQLLibrary.prototype.getCommitDetails = function(commit_name){
	let woql = new WOQLQuery().and(
		new WOQLQuery().triple("v:Commit", "ref:commit_id", commit_name),
		new WOQLQuery().triple("v:Commit", "ref:commit_timestamp", "v:Commit_Time"),
		new WOQLQuery().opt().triple("v:Commit", "ref:commit_parent", "v:Parent"),
		new WOQLQuery().opt().triple("v:Commit", "ref:commit_author", "v:Author"),
		new WOQLQuery().opt().triple("v:Commit", "ref:commit_message", "v:Message"),
	)
	return woql
}
