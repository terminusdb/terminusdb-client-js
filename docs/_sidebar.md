...
- [AccessControl](api/accessControl.js?id=AccessControl)
  ...
  - [createRole](api/accessControl.js?id=createRole)
  - [deleteRole](api/accessControl.js?id=deleteRole)
  - [getAllUsers](api/accessControl.js?id=getAllUsers)
  - [createUser](api/accessControl.js?id=createUser)
  - [deleteUser](api/accessControl.js?id=deleteUser)
  - [manageCapability](api/accessControl.js?id=manageCapability)
  - [getAccessRoles](api/accessControl.js?id=getAccessRoles)
  - [getOrgUsers](api/accessControl.js?id=getOrgUsers)
  - [getTeamUserRoles](api/accessControl.js?id=getTeamUserRoles)
...
- [TypeDef](api/typedef.js?id=TypeDef)
  ...
  - [CapabilityCommand](api/typedef.js?id=CapabilityCommand)
  - [RolesActions](api/typedef.js?id=RolesActions)
