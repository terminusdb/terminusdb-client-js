module.exports={
  ...
  "terminus:authority": {
      ...
      "terminus:authority_scope": [
   {
     ...
     "terminus:resource_name": {"@type":"xsd:string", "@value":"admin|TEST"}
   },
   {
     ...
     "terminus:resource_name": {"@type":"xsd:string", "@value":"admin|bike"}
   },
   {
     ...
     "terminus:resource_name": {"@type":"xsd:string", "@value":"admin|testing123"}
   },
   {
     ...
     "terminus:resource_name": {"@type":"xsd:string", "@value":"false|adfadsf"}
   },
   {
     "@id":"doc:terminus",
     "@type":"terminus:Database",
   ...
   },
   {
     ...
     "terminus:resource_name": {"@type":"xsd:string", "@value":"http://195.201.12.87:6380"}
   }
      ]
    }
  }
