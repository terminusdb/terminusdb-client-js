...
describe('IDParser tests', function () {
	...
	/*
	I have to ask the frame of a database to the TERMINUSDB
	the call is for the terminusdb 
	*/
	...
	it('test validPrefixedURL',function(){
        ...
        const docFullUrl='http://195.201.12.87:6363/terminus/document/myDocument'
